...
# run this file with: `sbatch --time=00:30:00 launch/snellius_entry.sh ...`

# Doc: https://apptainer.org/docs/user/main/cli/apptainer_exec.html
# not binding home to avoid cache conflicts (hugginface, zea, etc...!)
srun apptainer exec --env-file .env \
                    ...
                    /bin/bash launch/snellius_helper.sh "$@"
